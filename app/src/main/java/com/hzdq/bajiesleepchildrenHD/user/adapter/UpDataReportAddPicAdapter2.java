...
public class UpDataReportAddPicAdapter2 extends RecyclerView.Adapter<UpDataReportAddPicAdapter2.ViewHolder> {
    ...
    private OnClickItemListener1 mClickListener;
    ...
    public void setOnItemClickListener(OnClickItemListener1 listener){
        this.mClickListener = listener;
    }
    public UpDataReportAddPicAdapter2(Context context, List<Bitmap> list){
        this.context = context;
        this.list = list;
    }
    @NonNull
    @Override
    public UpDataReportAddPicAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(parent.getContext(), R.layout.item_update_report_add_pic,null);


        return new UpDataReportAddPicAdapter2.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UpDataReportAddPicAdapter2.ViewHolder holder, final int position) {
