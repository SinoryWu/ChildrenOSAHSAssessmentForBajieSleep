...
class LogoutDialog  (context: Context, confirmAction: ConfirmAction): Dialog(context, R.style.CustomDialog){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cancel = view.findViewById<TextView>(R.id.logout_cancel)
        val confirm = view.findViewById<TextView>(R.id.logout_confirm)
