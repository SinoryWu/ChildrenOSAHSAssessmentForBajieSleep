...
class DeleteDeviceDialog  (context: Context, confirmAction: ConfirmAction): Dialog(context, R.style.CustomDialog){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view: View =
            LayoutInflater.from(context).inflate(R.layout.dialog_delete_device, null)
        setContentView(view)
        window!!.setLayout(screenWidth,screenHeight )
        val cancel = view.findViewById<TextView>(R.id.delete_device_cancel)
        val confirm = view.findViewById<TextView>(R.id.delete_device_confirm)
