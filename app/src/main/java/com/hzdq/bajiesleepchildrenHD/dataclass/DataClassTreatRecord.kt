...
data class DataClassTreatRecord(
    @SerializedName("code")
    val code: Int = 0, // 0
    @SerializedName("msg")
    val msg: String = "", // success
    @SerializedName("data")
    val `data`: DataTreatRecord = DataTreatRecord()
)

data class DataTreatRecord(
    @SerializedName("current_page")
    val currentPage: Int = 0, // 1
    @SerializedName("data")
    val `data`: List<DataTreatRecordX> = listOf(),
