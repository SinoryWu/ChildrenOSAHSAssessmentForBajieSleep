...
data class DataClassHomeReportSleep(
    @SerializedName("code")
    val code: Int = 0, // 0
    @SerializedName("data")
    val `data`: DataHomeReportSleep = DataHomeReportSleep(),
    @SerializedName("msg")
    val msg: String = "" // ok
)

data class DataHomeReportSleep(
    @SerializedName("current_page")
    val currentPage: Int = 0, // 1
    @SerializedName("data")
    val `data`: List<DataHomeReportSleepX> = listOf(),
...
data class DataHomeReportSleepX(
