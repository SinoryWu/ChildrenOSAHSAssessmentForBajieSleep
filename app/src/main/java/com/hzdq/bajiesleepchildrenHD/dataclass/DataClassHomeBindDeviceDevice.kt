...
data class DataClassHomeBindDeviceDevice(
    @SerializedName("code")
    val code: Int = 0, // 0
    @SerializedName("data")
    val `data`: DataHomeBindDeviceDevice = DataHomeBindDeviceDevice(),
    @SerializedName("msg")
    val msg: String = "" // ok
)

data class DataHomeBindDeviceDevice(
    @SerializedName("data")
    val `data`: DataHomeBindDeviceDeviceX = DataHomeBindDeviceDeviceX(),
...
data class DataHomeBindDeviceDeviceX(
    @SerializedName("current_page")
    val currentPage: Int = 0, // 1
    @SerializedName("data")
    val `data`: List<DataHomeBindDeviceDeviceXX> = listOf(),
...
data class DataHomeBindDeviceDeviceXX(
