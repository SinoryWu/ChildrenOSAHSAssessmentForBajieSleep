...
data class DataClassFollowUpList(
    @SerializedName("code")
    val code: Int = 0, // 0
    @SerializedName("msg")
    val msg: String = "", // success
    @SerializedName("data")
    val `data`: DataFollowUpList = DataFollowUpList()
)

data class DataFollowUpList(
    @SerializedName("current_page")
    val currentPage: Int = 0, // 1
    @SerializedName("data")
    val `data`: List<DataFollowUpListX> = listOf(),
