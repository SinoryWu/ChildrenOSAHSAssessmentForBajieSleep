...
data class DataClassFrontUser(
    @SerializedName("code")
    val code: Int = 0, // 0
    @SerializedName("data")
    val `data`: DataFrontUser = DataFrontUser(),
    @SerializedName("msg")
    val msg: String = "" // ok
)

data class DataFrontUser(
    @SerializedName("current_page")
    val currentPage: Int = 0, // 20
    @SerializedName("data")
    val `data`: List<DataFrontUserX> = listOf(),
