...
data class DataClassHomeBindDeviceUser(
    @SerializedName("code")
    val code: Int = 0, // 0
    @SerializedName("data")
    val `data`: DataHomeBindDeviceUser = DataHomeBindDeviceUser(),
    @SerializedName("msg")
    val msg: String = "" // ok
)

data class DataHomeBindDeviceUser(
    @SerializedName("current_page")
    val currentPage: Int = 0, // 1
    @SerializedName("data")
    val `data`: List<DataHomeBindDeviceUserX> = listOf(),
...
data class DataHomeBindDeviceUserX(
    @SerializedName("id")
    val id: Int = 0, // 1283
    @SerializedName("uid")
    val uid: Int = 0, // 1460
