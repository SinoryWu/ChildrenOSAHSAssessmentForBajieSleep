...
data class DataClassQuestionResultList(
    @SerializedName("code")
    val code: Int = 0, // 0
    @SerializedName("msg")
    val msg: String = "", // success
    @SerializedName("data")
    val `data`: DataQuestionResultList = DataQuestionResultList()
)

data class DataQuestionResultList(
    @SerializedName("current_page")
    val currentPage: Int = 0, // 1
    @SerializedName("data")
    val `data`: List<DataQuestionResultListX> = listOf(),
...
data class DataQuestionResultListX(
    @SerializedName("id")
    val id: Int = 0, // 1126
    @SerializedName("uid")
    val uid: Int = 0, // 36
